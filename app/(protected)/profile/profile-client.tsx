...
import { GraduationCap, MapPin, Award, Edit, Save, X, User, Mail } from "lucide-react";
...
export default function ProfileClient({ session, initialProfile }: ProfileClientProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        targetDegree: initialProfile?.targetDegree || "",
        targetCountry: initialProfile?.targetCountry || "",
        intakeYear: initialProfile?.intakeYear || "",
        budgetRange: initialProfile?.budgetRange || "",
        fundingSource: initialProfile?.fundingSource || "",
        examStatus: initialProfile?.examStatus || "",
        sopStatus: initialProfile?.sopStatus || "",
    });
        ...
        return (
            <Card>
                <CardContent className="p-6">
                    <p className="text-center text-muted-foreground">No profile found. Please complete onboarding.</p>
                </CardContent>
            </Card>
        );
    }
                        ...
                        <>
                            <div className="grid grid-cols-[24px_1fr] gap-4 items-center">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="text-muted-foreground capitalize">{initialProfile.targetCountry}</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-[24px_1fr] gap-4 items-center">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="text-muted-foreground capitalize">{initialProfile.targetDegree}</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-[24px_1fr] gap-4 items-center">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="text-muted-foreground capitalize">{initialProfile.major} ({initialProfile.educationLevel})</p>
                                </div>
                            </div>
                        </>
                    ) : (
